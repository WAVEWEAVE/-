...
```
A humorous illustration of {meme_scene}, drawn in {art_style} with {color_tone} on a {background} background, {composition}. The joke reads entirely from the visual — no text, no speech bubbles. Flat vector style with solid fills and clean edges, rendered as print-ready graphic design. --ar 1:1 --style raw --s 300
```
...
| `--s` | `150` 절제 / `250` 권장 / `350` 과장 강조 | 이 그림체는 250 이하가 아웃라인이 더 깔끔하게 나와요 |
...
이 가이드는 **굵은 아웃라인 + 완전 플랫 채색** 스타일로 고정합니다. 현대 어패럴 그래픽(티셔츠·굿즈) 일러스트에 최적화된 그림체예요.

```
thick uniform black outlines with completely flat solid color fills and zero shading, organic rounded shapes with dynamic pose, like a modern graphic tee apparel illustration or contemporary streetwear character design
```
...
> | 색상 제한 강제 | `2 to 3 flat accent colors only` |
...
```
A humorous illustration of a tiny cartoon character desperately clinging to an oversized coffee cup twice their height, eyes wide with desperate gratitude, drawn in thick uniform black outlines with completely flat solid color fills and zero shading, organic rounded shapes with dynamic pose, like a modern graphic tee apparel illustration with burnt orange and off-white on a clean white background, centered as one large illustration filling the frame with wide margins. The joke reads entirely from the visual — no text, no speech bubbles. Flat vector style with solid fills and clean edges, rendered as print-ready graphic design. --ar 1:1 --style raw --s 250
```
...
```
A humorous illustration of a cartoon character enthusiastically punching an alarm clock mid-swing with gleeful determination, still in pajamas with wild bedhead hair, motion lines on the arm to suggest movement, drawn in thick uniform black outlines with completely flat solid color fills and zero shading, organic rounded shapes with dynamic pose, like a modern graphic tee apparel illustration with charcoal black and muted mustard yellow on a clean white background, centered as one large illustration filling the frame with wide margins. The joke reads entirely from the visual — no text, no speech bubbles. Flat vector style with solid fills and clean edges, rendered as print-ready graphic design. --ar 1:1 --style raw --s 250
```
...
```
A humorous illustration of a tiny cartoon human bowing deeply while serving gourmet food on a silver tray to a large imperious cat sitting on an ornate throne, the cat looking completely unimpressed with one paw raised dismissively, character shown in three-quarter view, drawn in thick uniform black outlines with completely flat solid color fills and zero shading, organic rounded shapes, like a modern graphic tee apparel illustration with charcoal black and warm terracotta on a clean white background, centered as one large illustration filling the frame with wide margins. The joke reads entirely from the visual — no text, no speech bubbles. Flat vector style with solid fills and clean edges, rendered as print-ready graphic design. --ar 1:1 --style raw --s 250
```
...
```
A humorous illustration of a raccoon character wearing a tiny crown, sitting possessively on a pile of snacks and miscellaneous treasures with a deeply satisfied expression, arms spread wide to guard everything, drawn in thick uniform black outlines with completely flat solid color fills and zero shading, organic rounded shapes, like a modern graphic tee apparel illustration with forest green and warm cream on a clean white background, centered as one large illustration filling the frame with wide margins. The joke reads entirely from the visual — no text, no speech bubbles. Flat vector style with solid fills and clean edges, rendered as print-ready graphic design. --ar 1:1 --style raw --s 250
```
...
```
A humorous illustration of a cartoon character melting off a couch like a liquid puddle, completely boneless and limp with heavy-lidded blissful eyes, a remote control loosely in one hand, drawn in thick uniform black outlines with completely flat solid color fills and zero shading, organic rounded shapes, like a modern graphic tee apparel illustration with deep navy and pale yellow on an off-white background, centered as one large illustration filling the frame with wide margins. The joke reads entirely from the visual — no text, no speech bubbles. Flat vector style with solid fills and clean edges, rendered as print-ready graphic design. --ar 1:1 --style raw --s 200
```
...
```
A humorous illustration of a round capybara character sitting perfectly still in the center of absolute chaos — objects flying, things falling, a tiny fire in the background — wearing a completely calm and indifferent expression, drawn in thick uniform black outlines with completely flat solid color fills and zero shading, organic rounded shapes, like a modern graphic tee apparel illustration with warm terracotta and off-white on a clean white background, centered as one large illustration filling the frame with wide margins. The joke reads entirely from the visual — no text, no speech bubbles. Flat vector style with solid fills and clean edges, rendered as print-ready graphic design. --ar 1:1 --style raw --s 250
```
...
```
A humorous illustration of a cartoon character being dragged horizontally across the floor by an enormous excited dog on a leash, the human's body stretched completely flat like a flag behind the sprinting dog, legs trailing in the air, motion lines behind both characters to suggest speed, drawn in thick uniform black outlines with completely flat solid color fills and zero shading, organic rounded shapes with dynamic pose, like a modern graphic tee apparel illustration with deep burgundy and warm cream on a clean white background, centered as one large illustration filling the frame with wide margins. The joke reads entirely from the visual — no text, no speech bubbles. Flat vector style with solid fills and clean edges, rendered as print-ready graphic design. --ar 1:1 --style raw --s 250
```
...
| `--s 250→150` | 더 절제되고 깔끔한 아웃라인 |
| `--s 250→350` | 캐릭터 과장과 표정이 더 강해짐 |
...
4. **`--s` 는 250 이하로.** 이 그림체는 스타일라이즈를 낮출수록 아웃라인이 더 깔끔하게 나옵니다.
